										...
										<article id="add-book-modal-' . $get_all_books[$i]['book_isbn'] .'" class="modal">
											...
											<article class="add-book-modal-content">
												...
												<article class="add-book-modal-body">
													...
													<input id="azaz" type="text" />
													<input id="input_reserve_name" type="text" placeholder="Enter your name" />
													<input id="input_reserve_email" type="email" placeholder="Enter your email" />
													<button class="reserve-btn" onclick="reserve(' . $get_all_books[$i]['book_isbn'] .');">RESERVE BOOK</button>
												</article>
											</article>
										</article>
...
<body>
	...
	<script type="text/javascript">
		...
		//	var reservationName = document.getElementById("azazaz").innerHTML;
		//	var reservationEmail = document.getElementById("azaz").value;
		//	var params = [isbn, reservationName, reservationEmail];
		//	
